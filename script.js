...
//      --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0NjQ4ZDhmMWRkMTk1MjEwM2I1YjExYTA3ZTA0N2Y2NSIsInN1YiI6IjY0ODJiMmM5OTkyNTljMDBmZjBkOTY0NiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.BfUp6rMxx_FOzZqxIIUl23-1Ge9490BpCw4gkg-S5N0' \
//      --header 'accept: application/json'

//  let fakeMoviesAPI = fetch(url).then((response) => response.json()).then((data) => {
	// your code here
// });
...
const options = {
  ...
  let fakeMoviesAPI = fetch('https://api.themoviedb.org/3/authentication', options)
...
//
 ...
 fakeMoviesAPI.results.forEach(generateCards)